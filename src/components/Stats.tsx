...
import { Bitcoin, MousePointer, Sparkles, Gauge, Recycle, BarChart, Gem, Timer } from 'lucide-react';
  ...
  return (
    <div className="bg-slate-900/60 border border-slate-700/60 rounded-lg p-2 mb-2 flex justify-between items-center">
      <div className="flex items-center">
        <div className="mr-2 text-lg">{boost.icon}</div>
        <div>
      ...
      {boost.duration ? (
        ...
        <div className="text-xs text-indigo-400 font-medium">Permanent</div>
      )}
    </div>
  );
};
