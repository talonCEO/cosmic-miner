...
const Stats: React.FC = () => {
  ...
  const levelData = getLevelFromExp(state.totalClicks * 10); // Assuming clicks contribute to XP
  const unlockedTitles = getUnlockedTitles(levelData.currentLevel.level, [], state.prestigeCount);
  const unlockedPortraits = getUnlockedPortraits(levelData.currentLevel.level, [], state.prestigeCount);
              ...
              <table className="w-full text-sm text-left text-slate-300">
                ...
                <tbody>
                  ...
                  <tr className="border-b border-slate-700/50">
                    ...
                    <td className="py-2 px-3 text-purple-300">{formatNumber(state.essence + calculatePotentialEssenceReward())}</td>
                  </tr>
                  <tr className="border-b border-slate-700/50">
              ...
              <table className="w-full text-sm text-left text-slate-300">
                ...
                <tbody>
                  ...
                  <tr className="border-b border-slate-700/50">
                    ...
                    <td className="py-2 px-3 text-cyan-300">{formatNumber(state.totalClicks * 10)} / {formatNumber(levelData.nextLevel?.expRequired || 0)}</td>
                  </tr>
                  <tr className="border-b border-slate-700/50">
                  ...
                  <tr className="border-b border-slate-700/50">
                    ...
                    <td className="py-2 px-3 text-cyan-300">{unlockedTitles.length} / {state.titles?.length || 10}</td>
                  </tr>
                  <tr className="border-b border-slate-700/50">
                    <td className="py-2 px-3">Portraits Unlocked</td>
                    <td className="py-2 px-3 text-cyan-300">{unlockedPortraits.length} / {state.portraits?.length || 5}</td>
                  </tr>
                  <tr className="border-b border-slate-700/50">
