                    ...
                    <div className="flex gap-1 justify-end mt-2 flex-wrap">
                      {[1, 10, 50, 100].map(quantity => (
                        <button
                          ...
                          className="px-2 py-0.5 bg-slate-700/50 hover:bg-slate-600/50 rounded text-xs font-medium transition-colors flex-shrink-0"
                          title={`Buy ${quantity}`}
                        >
                          {quantity}
                        </button>
                      ...
                      <button
                        ...
                        className={`px-2 py-0.5 ${isTapUpgrade ? 'bg-amber-700/50 hover:bg-amber-600/50' : 'bg-indigo-700/50 hover:bg-indigo-600/50'} rounded text-xs font-medium transition-colors flex-shrink-0`}
