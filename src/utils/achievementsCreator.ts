...
import GemIcon from '@/assets/images/icons/gem.png';
import BoostIcon from '@/assets/images/icons/boost.png';
import TitleIcon from '@/assets/images/icons/title.png';
import PortraitIcon from '@/assets/images/icons/portrait.png';
...
export const createAchievements = (): Achievement[] => {
  return [
    ...
    { id: 'prestige-5', name: 'Eternal Cycle', description: 'Prestige 50 times', unlocked: false, checkCondition: (state: GameState) => state.prestigeCount >= 50, rewards: { type: 'portrait', value: 'eternal_traveler', image: PortraitIcon } },
    ...
    { id: 'managers-2', name: 'Galactic Overseer', description: 'Own all managers', unlocked: false, checkCondition: (state: GameState) => state.ownedManagers.length >= state.managers.length, rewards: { type: 'portrait', value: 'galactic_overseer', image: PortraitIcon } },
    ...
    { id: 'boosts-1', name: 'Boost Addict', description: 'Activate 50 boosts', unlocked: false, checkCondition: (state: GameState) => Object.values(state.boosts).reduce((total, b) => total + (b.purchased || 0), 0) >= 50, rewards: { type: 'portrait', value: 'boost_addict', image: PortraitIcon } },
