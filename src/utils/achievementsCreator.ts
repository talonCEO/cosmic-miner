...
export const createAchievements = (): Achievement[] => {
  return [
    ...
    { id: 'clicks-6', name: 'Tap Titan', description: 'Tap 10,000,000 times', unlocked: false, checkCondition: (state: GameState) => state.totalClicks >= 10000000, rewards: { type: 'portrait', value: 'asteroid_blaster', image: PortraitIcon1 } },
    ...
    { id: 'income-5', name: 'Universal Conglomerate', description: 'Earn 1,000,000,000,000,000 coins', unlocked: false, checkCondition: (state: GameState) => state.totalEarned >= 1000000000000000, rewards: { type: 'portrait', value: 'cosmic_overlord', image: PortraitIcon2 } },
    ...
    { id: 'upgrades-4', name: 'Upgrade Overlord', description: 'Get 5 upgrades to level 1000', unlocked: false, checkCondition: (state: GameState) => state.upgrades.filter(u => u.level >= 1000).length >= 5, rewards: { type: 'portrait', value: 'galactic_guardian', image: PortraitIcon3 } },
    ...
    { id: 'prestige-5', name: 'Eternal Cycle', description: 'Prestige 50 times', unlocked: false, checkCondition: (state: GameState) => state.prestigeCount >= 50, rewards: { type: 'portrait', value: 'eternal_traveler', image: PortraitIcon4 } },
    ...
    { id: 'passive-5', name: 'Idle Sovereign', description: 'Reach 1 quadrillion coins per second (1e15)', unlocked: false, checkCondition: (state: GameState) => state.coinsPerSecond >= 1e15, rewards: { type: 'portrait', value: 'nebula_voyager', image: PortraitIcon4 } },
    ...
    { id: 'managers-2', name: 'Galactic Overseer', description: 'Own all managers', unlocked: false, checkCondition: (state: GameState) => state.ownedManagers.length >= state.managers.length, rewards: { type: 'portrait', value: 'galactic_overseer', image: PortraitIcon4 } },
    ...
    { id: 'boosts-1', name: 'Boost Addict', description: 'Activate 50 boosts', unlocked: false, checkCondition: (state: GameState) => Object.values(state.boosts).reduce((total, b) => total + (b.purchased || 0), 0) >= 50, rewards: { type: 'portrait', value: 'boost_addict', image: PortraitIcon4 } },
